...
async def ticketing(intrct, type: str):
    match type.lower():
        case 'вопросы':
            ...
            client.add_view(ticket_launcher.question())
        case 'баги':
            embed = discord.Embed(title="Пожаловаться на баг.", description="Здесь можно написать жалобу на баг.", color=config.danger)
...
> <@&1134198325189562468> - роль главы сервера 
