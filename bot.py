...
async def rules(intrct):
    embed = discord.Embed(title='📑 Правила сервера Discord', description='''
    ...
    **Дополнение: Правила 1, 3, 4, 5 не работают если никто не против их нарушения.** 
    ...
    links = discord.Embed(title = '🔬 Правила на GitBook', description = '''
    ...
    await intrct.response.send_message(embeds = [embed, links])
