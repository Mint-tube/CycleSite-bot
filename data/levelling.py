...
async def xp_on_message(message: discord.Message):
    ...
    if member.bot == False and message.channel.id not in [1123192369630695475, 1122481071330689045] and message.category.id not in [1132586162356244480, 1133666070390132776]:
